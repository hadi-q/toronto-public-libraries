...
All relevant data was sourced from the Open Data Toronto portal, and extracted using the opendatatoronto library for R [@rOpendatatoronto]. In particular, one dataset was used for the graphs and analyses in this paper [TO DO]
