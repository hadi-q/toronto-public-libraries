...
The data was generated, extracted, and cleaned using R [@r], leveraging functions from tidyverse [@rTidyverse], ggplot2 [@rGgplot2], dplyr [@rDplyr], readr [@rReadr], tibble [@rTibble], janitor [@rJanitor], kableExtra [@rKableExtra], naniar [@rNaniar] and knitr [@rKnitr].
