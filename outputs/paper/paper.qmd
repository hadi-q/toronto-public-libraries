...
analysis_data = read_csv(
  file = here("inputs/data/analysis_data.csv"),
...
All relevant data was sourced from the Open Data Toronto portal, and extracted using the [@opendatatoronto] library for R. In particular, one dataset was used for the graphs and analyses in this paper
